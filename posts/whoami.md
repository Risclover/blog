...
I may as well have been born with a keyboard in my hand, largely thanks to my dad being a programmer who often worked from home. In 1996 at the ripe age of 4, I had my first ever experience with a computer when my dad let me play Galaga on our home PC. He, for his part, was unbelievably good at Galaga. As for me, well... I was 4.

<img class="toby-img" style="width: 50%; margin-top: 1rem" src="/images/galaga.gif" />

As soon as I was allowed to go onto the Internet, I quickly fell in love with the wide variety of things to do - websites to discover, games to play, knowledge to learn. By the time I was 13, I had transitioned to preferring to spend most of my time at home on my computer (don't worry, I wasn't a hermit or anything!).

During these early years, I naturally started tinkering with website creation, crafting my first (let's call it _charmingly chaotic_) single-page monstrosity using just HTML and CSS when I was 14. In the years that followed, being a student at a "technologically advanced high school" offered me the chance to take a few web design courses, fueling my interest and curiosity in the topic even further.
...
For the doubters, take a look at the below snippet of code, an example pulled directly from one of my old Google Sheets projects.

<img class="toby=img" style="width: auto" src="/images/google-sheets-example.png" />

Come on. You can't convince me that that's not code.

In other words, I was dabbling in code before I even knew it was _code_, using many of the same concepts I'd later learn in "real" programming languages like Python and JavaScript.

Although I didn't know it at the time, this first taste of coding would eventually evolve into a life-long love affair with programming real, usable software, with a particular focus on providing a great user experience.

## Falling in Love with the Frontend

The majority of my 20's was spent persuing other interests. Then came COVID — a time of lockdowns, chaos, and, for me, a deep dive into frontend engineering. Forced to be nowhere but home, my interest in programming became prevailant, and I immersed myself in free curriculums on websites like <a href="https://freecodecamp.org">freeCodeCamp</a> and <a href="https://theodinproject.com">The Odin Project</a> - devouring tutorials, building projects, and falling head over heels for the art of creating seamless, user-friendly interfaces. Not even a month had passed before I realized that this was exactly what I wanted to do for the rest of my life, and that I had finally found my true calling.
...
When I'm not immersed in lines of code (a rarity, I assure you), I like to spend my time with my other big interest, playing video games. Outside of that, you might find me watching awesome animated shows like Arcane, studying the Spanish language for fun, or expressing myself through writing.
