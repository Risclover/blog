        ...
        <div className="project-content font-wotfard text-lg w-full lg:pl-6 flex-1 min-w-0">
          ...
          <div className="project-details">
            ...
            <p>
              ...
              emulates the essence of Uncrate.com, a renowned online magazine
              that curates and shares unique and noteworthy products across
              various categories. This project was brought to life through the
              collective efforts of a collaborative team comprising myself and
              three other skilled software engineers. The development involved a
              synergy of expertise in software engineering, full-stack
            ...
            <p>
              ...
              immersive experience of discovering and exploring curated
              products. With a robust feature set that includes image uploads
              via AWS S3, product listings, user accounts, profiles, favorite
              products, cart, order history, and a responsive design, Reduncrate
              reflects the culmination of diverse skills and collaborative
              endeavors.
            </p>
            <h2
              id="project-goals"
            ...
            <p>
              ...
              while incorporating seamless user experience and collaboration
              among team members. The project's objectives were outlined as
              follows:
            </p>
            ...
            <ol>
              ...
              <li>
                ...
                and visually appealing user interface design to ensure
              ...
              <li>
                ...
                three other software engineers to develop different aspects of
                the application while ensuring harmonious integration.
              </li>
            </ol>
            <h2
              id="tech-stack"
            ...
            <ul className="project-ul">
              <li>
                ...
                management ensured dynamic, responsive, and interactive user
                interfaces.
              </li>
              <li>
                <strong>Backend:</strong> Employing{" "}
                <span className="text-pink-500">Flask</span>, a lightweight
                Python web framework, facilitated server setup, routing, and API
                development.
              </li>
              <li>
            ...
            <p>
              My team and I carefully selected features that would help
              Reduncrate feel like Uncrate as much as possible whilst also
            ...
            <ul className="project-ul">
              ...
              <li>
                <strong>Complex UI components:</strong> Designing and
                implementing the complex image carousel and "suggested products"
                section demanded a deep understanding of frontend technologies
            ...
            <p>
              As a core contributor to Reduncrate's development, my primary
              focus was on the frontend aspect, where I played a pivotal role in
              shaping the user interface and enhancing user experience. Here are
              the key areas where I made substantial contributions:
            </p>
            <ol>
              <li>
                <strong>Single product page:</strong> I took charge of designing
                and implementing the intricate user interface for the single
                product page. This included crafting a complex image carousel
                that not only seamlessly showcased multiple product images, but
                also allowed full interactivity including through mouse click,
                mouse drag, touch, and keyboard. The carousel enabled users to
                explore a product's various angles and appearance variations
                (i.e. color).
              ...
              <li>
                ...
                overall user interface. By thoughtfully incorporating my own
                take on the footer to best fit our site, the footer contributed
                to the website's visual appeal.
                <ImageModal
              ...
              <li>
                <strong>Search feature</strong>: Although most of my
                contribution to this project was on the frontend, I took charge
                of both the frontend and backend development of the search
                feature. This allowed users to explore products based on names
                and description keywords, enhancing their ability to discover
                items of interest.
              </li>
            </ol>
            <h2
            ...
            <p>
              The development of Reduncrate paved the way for invaluable
            ...
            <ul className="project-ul">
              ...
              <li>
                <strong>User-centric development:</strong> Incorporating
                features like favorite products, cart, and order history
