...
import DbDiagramDark from "public/images/projects/ribbit/db_diagram_dark.png";
        ...
        <div className="project-content font-wotfard text-lg w-full lg:pl-6 flex-1 min-w-0">
          ...
          <div className="project-details">
            ...
            <p>
              ...
              produce the result you see today. While it would be impossible to
              list all of them, here are just some of the bigger ones.
            </p>
            ...
            <p>
              ...
              write the backend for multiple features before touching the
              frontend. That approach quickly fell apart - the website was
              seriously buggy, and debugging it was a nightmare due to code so
              entangled that fixing one thing meant breaking a few others.
            </p>
            <ImageModal
            ...
            />
            <p>
              As a result, progress stalled. Unfortunately, I had a deadline,
              and time was running out. Thus, one week in, I made the difficult
              decision to scrap everything I'd built, saving only the CSS, and
              start from scratch. This time, I switched to developing one full
              feature at a time, front to back. This change was vital, and
              resulted in Ribbit not only being exponentially less buggy, but,
              more importantly, possible to debug.
            </p>
            <ImageModal
            ...
            <p>
              ...
              some point, I realized I was writing my code to make it{" "}
              <em>work</em>, completely ignoring its quality. Upon this
              realization, I hit pause and launched a major refactor effort:
              modularized component, the usage of CSS variables, meaningful Git
              commits, and adherence to best practices.
            </p>
            <p>
              Now, instead of dreading 500-line files writhe with duplications,
              multiple responsibiltiies, and not a custom hook in sight, I can
              be - and am - proud of the structure, readability, and
              maintainability of my codebase.
            </p>
            <p>
              Let's see an example, shall we? This is one of Ribbit's
              components, <code>SinglePost</code>, before the Great Ribbit
              Refactor of 2024:
            </p>
            <Code
              language="javascript"
                      ...
                      <table className="divide-y divide-gray-200 dark:divide-neutral-700">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                          <tr>
                            ...
                            <td className="p-2 text-sm  dark:text-neutral-200">
                              Lightweight micro-framework, declarative ORM,
                              shared session between HTTP and WebSockets.
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td className="p-2 text-sm  dark:text-neutral-200">
                              Reliable JSON + full-text search, easy
                              Heroku/Render deploy.
                            </td>
                          </tr>
