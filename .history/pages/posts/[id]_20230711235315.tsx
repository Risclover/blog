...
export default function Post({
  ...
  useEffect(() => {
    ...
    headings.forEach((heading: any) =>
      heading.setAttribute("id", heading.textContent.toLowerCase())
    );
  });
  console.log("HEADINGS:", fileContent);
  return (
    <Layout postData={postData}>
      <Head>
        <title>{postData.title}</title>
      </Head>
      <div className="max-w-6xl mx-auto w-full px-12 py-20 flex flex-row-reverse dark:text-white">
        <div>
