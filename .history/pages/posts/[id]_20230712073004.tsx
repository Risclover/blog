...
export default function Post({
  ...
  useEffect(() => {
    ...
    headings.forEach((heading: any) => {
      ...
      console.log("HEADING:", heading.nodeName);
  ...
  return (
    <Layout postData={postData}>
      ...
      <div
        ref={headingsRef}
        className="mx-auto max-w-5xl w-full px-12 py-20 flex flex-row-reverse dark:text-white"
      >
        {fileContent.length > 0 && (
          <TableOfContents headings={fileContent} headingsRef={headingsRef} />
        )}
        <div className="blog-post text-slate-900 font-medium text-lg leading-8 font-wotfard dark:text-white">
